...
from gaussian_renderer import render, render_original, render_canonical
import torchvision
...
def render_set_canonical(model_path, name, iteration, views, gaussians, pipeline, background, cam_type, gvc_params):
    ...
    for idx, view in enumerate(tqdm(views, desc="Rendering progress")):
        ...
        if gvc_params["GVC_testmode"] == 0:
            ...
            rendering = render_canonical(gvc_params, view, gaussians, pipeline, background, cam_type=cam_type, canonical_times='local_still', still_camera=initla_camera)["render"]
        else:
            raise ValueError("GVC_testmode should be 0 or 1")
    ...
    for idx, view in enumerate(tqdm(views, desc="Rendering progress")):
        ...
        if gvc_params["GVC_testmode"] == 0:
            ...
            rendering = render_canonical(gvc_params, view, gaussians, pipeline, background, cam_type=cam_type, canonical_times='global')["render"]
        else:
            raise ValueError("GVC_testmode should be 0 or 1")
    ...
    for idx, view in enumerate(tqdm(views, desc="Rendering progress")):
        ...
        if gvc_params["GVC_testmode"] == 0:
            ...
            rendering = render_canonical(gvc_params, view, gaussians, pipeline, background, cam_type=cam_type, canonical_times='local')["render"]
        else:
            raise ValueError("GVC_testmode should be 0 or 1")
    ...
    for idx, view in enumerate(tqdm(views, desc="Rendering progress")):
        ...
        if gvc_params["GVC_testmode"] == 0:
            ...
            rendering = render_canonical(gvc_params, view, gaussians, pipeline, background, cam_type=cam_type, canonical_times='render_still', still_camera=initla_camera)["render"]
        else:
            raise ValueError("GVC_testmode should be 0 or 1")
