...
# rendering time 기록용 log file 생성
echo "Rendering time" > output/${output_path}/rendering_time.txt
...
for scene in $scenes; do
	...
	PYTHONPATH='.' CUDA_VISIBLE_DEVICES=$GPU_id python render.py --model_path "output/${output_path}/${scene}" --skip_train --configs arguments/${dataset}/${config}.py >> output/${output_path}/rendering_time.txt
