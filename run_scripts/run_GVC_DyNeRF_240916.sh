...
for scene in $scenes; do
	...
	# rendering
	PYTHONPATH='.' CUDA_VISIBLE_DEVICES=$GPU_id python render.py --model_path "output/dynerf/${scene}"  --skip_train --configs arguments/dynerf/${scene}.py --GVC_testmode ${GVC_testmode} >> ${log_dir}
