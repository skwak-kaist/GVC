...
from scene.deformation import deform_network, deform_network_scaffold
...
class GaussianModel:
    ...
    def __init__(self, args, 
        ...
        '''
        # Skip the 4DGS-related attributes
        self.active_sh_degree = 0
        self.max_sh_degree = sh_degree  
    ...
    '''
    def create_from_pcd_original(self, pcd : BasicPointCloud, spatial_lr_scale : float, time_line: int):
